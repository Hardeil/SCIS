  ...
  const totalInventory = () => {
    ...
    axios.get(apiUrl).then((response) => {
      ...
      if (data.error) {
        ...
        setTotalSupplier(data.supplier?.total_supplier);
        setTotalPurchase(data.purchase?.total_purchase);
  ...
  return (
    <Container maxWidth="xl">
      ...
      <Grid container spacing={3}>
        ...
        <Grid xs={12} sm={6} md={4}>
          <AppWidgetSummary
            title="Total Item Purchase"
            total={totalPurchaseItem}
            color="warning"
            icon={<img alt="icon" src="/assets/icons/glass/ic_glass_bag.png" />}
          />
        </Grid>
        ...
        {/* <Grid xs={12} sm={6} md={6}>
          ...
          <Table>
            ...
            <TableBody style={{ backgroundColor: 'white' }}>
              {purchase.map((obj,i) => (
                <TableRow key={obj.purchase_id}>
                  <TableCell>{obj.purchase_delivered_date}</TableCell>
                  <TableCell>{obj.prod_name}</TableCell>
                  <TableCell>{obj.purchase_quantity}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
        ...
        <Grid xs={12} sm={6} md={6}>
          <h1>Recent Release Product</h1>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell>Release Date</TableCell>
                <TableCell>Release Product</TableCell>
                <TableCell>Release Quantity</TableCell>
              </TableRow>
            </TableHead>
            <TableBody style={{ backgroundColor: 'white' }}>
              {release.map((obj) => (
                <TableRow key={obj.release_id}>
                  <TableCell>{obj.release_date}</TableCell>
                  <TableCell>{obj.prod_name}</TableCell>
                  <TableCell>{obj.release_release}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
