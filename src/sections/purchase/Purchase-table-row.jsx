...
export default function PurchaseTableRow({
  ...
  const addLinkClick = () => {
    router.push(
      `${routers.purchase_edit.route}/${purchase?.purchase_id}/${purchase?.reg_ID}/${purchase?.prod_id}/${purchase?.sup_id}`
    );
    handleCloseMenu();
  };
  const viewLinkClick = () => {
    router.push(
      `/viewPurchase/${purchase?.purchase_id}/${purchase?.reg_ID}/${purchase?.prod_id}/${purchase?.sup_id}`
    );
    handleCloseMenu();
  };
  return (
